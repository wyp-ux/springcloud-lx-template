package cn.tycoding.auth.feignservice;

import cn.tycoding.auth.feignservice.feignserviceimpl.AuthFeignServiceimpl;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;

@FeignClient(value = "template-admin",fallback = AuthFeignServiceimpl.class)
